...
// get user's data
const username = prompt("Welcome to CHATROOM 8219038091239081231257124! \nPlease enter your username to continue!")
...
function sendMessage(e) {
  ...
  db.ref("channel-8219038091239081231257124/" + timestamp).set({
    username,
    message,
  });
}
...
const fetchChat = db.ref("channel-8219038091239081231257124/");

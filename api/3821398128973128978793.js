...
// get user's data
const username = prompt("Welcome to CHATROOM 3821398128973128978793! \nPlease enter your username to continue!")
...
function sendMessage(e) {
  ...
  db.ref("channel-3821398128973128978793/" + timestamp).set({
    username,
    message,
  });
}
...
const fetchChat = db.ref("channel-3821398128973128978793/");

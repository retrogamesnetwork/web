...
// get user's data
const username = prompt("Welcome to CHATROOM 48791879237239781289372! \nPlease enter your username to continue!")
...
function sendMessage(e) {
  ...
  db.ref("channel-48791879237239781289372/" + timestamp).set({
    username,
    message,
  });
}
...
const fetchChat = db.ref("channel-48791879237239781289372/");
